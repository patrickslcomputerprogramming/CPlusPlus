...
//Invite, Read, Validate and Save input data
    do
    {
        cout << "Combien de nombres uniques voulez-vous génerer aléatoirement?\n";
        cout << "SVP, entrez un nombre plus grand que 1:\n";
        ...
        {
            cout << "ERREUR!!! Vous n'avez pas mis un nombre plus grand que 1 \n";
        }
...
void identify_highest_number(int arrayOfNumbers[], int arraySize)
{
    ...
    //Display output data
    cout<<"Les "<<arraySize<<" nombres uniques suivants ont été générés: "<<endl;
    ...
    //Display output data
    cout<<endl;
    cout<<"Le plus grand nombres parmi eux est le nombre "<<highest_number<<endl;
}
